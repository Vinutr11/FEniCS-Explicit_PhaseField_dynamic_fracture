...
Vtk_dis = File('pfm_impact_problem/disp.pvd')
Vtk_pf = File('pfm_impact_problem/Phase_field.pvd')
...
plt.figure()
plt.tight_layout()
plt.plot(1e5*time, energies[:,0])
plt.xlabel("Time X 1e-5")
plt.ylabel("EE")
plt.title("Strain Energy (J)")
plt.savefig("Strain Energy")


plt.figure()
plt.tight_layout()
plt.plot(1e5*time, energies[:,1])
plt.xlabel("Time X 1e-5")
plt.ylabel("SE")
plt.title("Crack Energy (J)")
