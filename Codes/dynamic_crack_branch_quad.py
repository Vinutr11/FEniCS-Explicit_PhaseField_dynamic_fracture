...
mesh = RectangleMesh.create([Point(0,0),Point(0.1,0.04)],[400,160],CellType.Type.quadrilateral)
...
xdmf_file = XDMFFile('Crack_branch_problem/results.xdmf')
...
sig = Function(TT, name = 'Stress_Fields')
sig.assign(project(sigma(u_old_,pold),TT))

xdmf_file.write(u_old_,time[-1])
xdmf_file.write(sig,time[-1])
