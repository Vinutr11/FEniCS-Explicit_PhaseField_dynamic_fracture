...
k = assemble(a)                            # Assembling LHS and applying boundary condition for equation of motion
f = PETScVector()

solver = LUSolver(k,'mumps')
solver.parameters['symmetric'] = True

phi_problem = LinearVariationalProblem(lhs(form_phi),rhs(form_phi),p_new,bcs=None)      # Phase field equation
